# Alaska Airlines Terraform Modules Contributing Guidelines
...
1. Use the search option under Issues — check if the issue has already been reported
...
A good bug report shouldn't leave others needing to chase you up for more information. Please try to be as detailed as possible in your report. What is your environment? What steps will reproduce the issue? What parameters experience the problem? What would you expect to be the outcome? All these details will help people to fix any potential bugs.
